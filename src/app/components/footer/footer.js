...
export default function footer() {
  return (
    <div className="footer">
      <div className="w-full mt-10 lg:p-20 pb-20 p-10 bg-theme-footer">
          ...
          <div className="lg:flex grid grid-cols-1 gap-20 justify-center">
            ...
            <div className="subcribe space-y-5 lg:mt-8">
              ...
              <div className="input-box  bg-white rounded-lg">
                <div className="flex justify-between box-border p-2 gap-5">
                  <input
                    type="email"
                    className="p-2 rounded-lg text-sm pl-4 outline-none"
                    placeholder="Masukan Email Anda.."
                  />
                  <button className="text-white font-semibold bg-theme-primary rounded-lg px-5 py-2">
                    Subscribe
                  </button>
                </div>
              </div>
      ...
      <div className="flex bg-theme-footer justify-center  border-t p-5">
        <p className="text-white font-semibold text-sm">
          Copyright &copy; 2023 Noga Sahrull. All Rights Reserved
        </p>
      </div>
    </div>
  );
